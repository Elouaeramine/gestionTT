...
class ContratsTraites extends React.Component {
  ...
  componentDidMount(){
    ...
    jsonWebService.post(url,{owner}).then((response) => {
             ...
             this.setState({ tableContrats : response.treatedcontrats});
             this.sliceTable(response.treatedcontrats)
        }).catch((err)=> {
...
export default ContratsTraites;